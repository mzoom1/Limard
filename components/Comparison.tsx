    ...
    <section className="py-24 bg-[#111111] border-t border-white/10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl">
            <div 
                ref={containerRef}
                className="relative w-full aspect-[16/9] md:aspect-[21/9] rounded-2xl overflow-hidden cursor-ew-resize select-none shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/10"
